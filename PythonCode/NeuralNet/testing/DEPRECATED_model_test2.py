...
class TextClassificationModel:
    def __init__(self, num_classes, use_pretrained_embeddigns=True, max_features=None, embedding_dim=16, sequence_length=500):
    ...
    def build_model(self):
        ...
        if self.use_pretrained_embeddings:
            ...
            model.add(layers.Embedding(input_dim=self.max_features, output_dim=self.embedding_dim,
    ...
    def compile_model(self):
        self.model.compile(optimizer='adam', loss='binary_crossentropy', metrics=[BinaryAccuracy(name='accuracy'), 
