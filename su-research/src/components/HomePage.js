        ...
        <main>
          ...
          <section className="text-center mb-12 z-30 relative" style={{position: 'relative'}}>
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold bg-clip-text text-transparent"
                style={{
                    backgroundImage: 'linear-gradient(to right, #D2122E 28%, yellow 72%)', // Gradient color from maroon to yellow
                    WebkitBackgroundClip: 'text', // Applying the gradient to the text
                    WebkitTextFillColor: 'transparent' // Making the text color transparent to show the gradient
                }}>
                Salisbury Research
            </h1>
